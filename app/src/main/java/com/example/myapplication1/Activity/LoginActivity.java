...
public class LoginActivity extends AppCompatActivity {
    ...
    private UserAccount pazzleman;         //数据库对象
    @Override
    ...
    public void initView() {
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pazzleman.open();
                if (pazzleman.isExist(acc) == false) {
                    Toast.makeText(LoginActivity.this,"账号不存在，请重新输入！", Toast.LENGTH_SHORT).show();
                } else {
                    if (pazzleman.getPassword(acc).equals(pass)) {
                        Intent intent = new Intent(LoginActivity.this, ChoosePicture.class);
                        //创建意图对象，进行跳转
